...
class _StudentDashboardWidgetState extends State<StudentDashboardWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ClassroomTableRow>>(
      future: ClassroomTableTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<ClassroomTableRow> studentDashboardClassroomTableRowList =
            snapshot.data!;

        final studentDashboardClassroomTableRow =
            studentDashboardClassroomTableRowList.isNotEmpty
                ? studentDashboardClassroomTableRowList.first
                : null;
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 8.0),
                                    child:
                                        FutureBuilder<List<ClassroomTableRow>>(
                                      future: ClassroomTableTable().queryRows(
                                        queryFn: (q) => q.order('currentPts'),
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                ...
                                child: Stack(
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 8.0),
                                      child: FutureBuilder<List<TasksTableRow>>(
                                        future: TasksTableTable().queryRows(
                                          queryFn: (q) => q.eqOrNull(
                                            'stuId',
                                            widget!.userId,
                                          ),
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            scrollDirection: Axis.vertical,
                                            itemCount: listViewTasksTableRowList
                                                .length,
                                            itemBuilder:
                                                (context, listViewIndex) {
                                ...
                                child: Stack(
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 8.0),
                                      child: FutureBuilder<List<ShopTableRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            scrollDirection: Axis.vertical,
                                            itemCount:
                                                listViewShopTableRowList.length,
                                            itemBuilder:
                                                (context, listViewIndex) {
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewShopTableRow.price?.toString(),
                                                                            '0',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewShopTableRow.quantity?.toString(),
                                                                            '0',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
